...
<div id="main" class="posts-index loop">
	...
	if ( have_posts() ) :
		...
		<?php // Pagination
		$prev = get_previous_posts_link( '<span class="fa fa-angle-left"></span>' . __( 'Forrige indlæg', 'pixie' ) );
		$next = get_next_posts_link( __( 'Næste indlæg', 'pixie' ) . '<span class="fa fa-angle-right"></span>' );
		?>
