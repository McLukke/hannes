...
<div id="main" class="post-single loop">
	...
	if ( have_posts() ) :
		...
		ob_start(); previous_post_link( '%link', '<span class="fa fa-angle-left"></span>' . __( 'Forrige indlæg', 'pixie' ) ); $prev = ob_get_clean();
		ob_start(); next_post_link( '%link', __( 'Næste indlæg', 'pixie' ) . '<span class="fa fa-angle-right"></span>' ); $next = ob_get_clean();
