		...
		<div class="post-related">
			...
			<div class="center-wrapper">
				<div class="post-related-index container">
					...
					<header>
						<h3 class="post-related-heading typography-big-heading"><?php _e( 'Related Posts', 'pixie' ); ?></h3>
					</header>
					...
					<?php while ( have_posts() ) : the_post();
						...
						<div id="related-post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<span class="post-related-meta typography-meta"><?php echo esc_html( get_the_date() ); ?></span>
