...
class Pixie_Widget_Random_Posts extends WP_Widget {

	function __construct() {
		parent::__construct(
			'pixie_random_posts',
			__( 'Pixie: Random Posts', 'pixie' ),
			array( 'description' => __( 'Random Posts list with thumbnail images', 'pixie' ) )
		);
	...
	public function widget( $args, $instance ) {
		$cache = wp_cache_get( 'widget_pixie_random_posts', 'widget' );
		...
		if ( have_posts() ) :
			...
			wp_cache_set( 'widget_pixie_random_posts', $cache, 'widget' );
	...
	function flush_widget_cache() {
		wp_cache_delete( 'pixie_random_posts', 'widget' );
	}

}

// register
function register_widget_pixie_random_posts() {
    register_widget( 'Pixie_Widget_Random_Posts' );
}
add_action( 'widgets_init', 'register_widget_pixie_random_posts' );